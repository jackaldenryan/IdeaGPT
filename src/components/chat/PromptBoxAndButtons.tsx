...
export default function PromptBoxAndButton({ onNewIdeas, ideas }: PromptBoxAndButtonsProps) {
  const [prompt, setPrompt] = useState('');
  const [options, setOptions] = useState({ numIdeas: 10, modelType: 'gpt-4o-mini' });
